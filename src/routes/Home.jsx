...
function Home() {
  return (
    ...
    <div className=" text-5xl md:text-7xl md:mt-0 mt-60 md:pt-0 lg:ml-80 min-w-fit text-center flex flex-col font-black justify-center">
      <div className=" text-white text-center md:mt-0 mt-20">Total Value Locked</div>
      <div className=" text-purple-600">21.726.882$</div>
    </div>

    <div className='absolute bottom-40 lg:flex lg:relative  lg:bottom-0'>
      <img className=" object-contain lg:translate-x-20 lg:-rotate-90 lg:relative md:scale-150  bottom-10" src={bgHome} alt="" />
      </div>
    </div>
    </div>
  )
