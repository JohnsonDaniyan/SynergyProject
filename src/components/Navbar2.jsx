...
function Navbar2() {
  ...
  <ul class="tracking-widest flex flex-col p-4 mt-4 bg-black rounded-lg border border-gray-100 md:flex-row md:space-x-3 lg:space-x-8 md:mt-0 md:text-lg lg:text-3xl md:font-medium md:border-0 md:bg-black w-1000 justify-between">
    <li>
